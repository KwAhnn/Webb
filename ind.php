...
$canonical_url = "http://www.cuulongresort.com/trang-chu";
?>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-lg-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="./view/about.php">Giới thiệu</a></li>
                    <li class="nav-item"><a class="nav-link" href="./view/service.php">Dịch vụ</a></li>
                    <li class="nav-item"><a class="nav-link" href="./view/tour.php">Tour du lịch</a></li>
                    <li class="nav-item"><a class="nav-link" href="./view/room.php">Đặt phòng</a></li>
            ...
            <div class="container">
                <div class="row align-items-center" data-aos="fade-top">
                    <div class="col-lg-6 col-12 mx-auto">
                        ...
                        <a class="btn custom-btn smoothscroll me-2 mb-2" href="./view/contact.php">Liên hệ</a>
                        <a class="btn custom-btn smoothscroll me-2 mb-2" href="./view/room.php"><strong>Loại phòng</strong></a>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid px-4">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-12 mt-4 mt-lg-0 mx-auto" style="text-align: justify;" data-aos="fade-left">
                        ...
                        <a class="smoothscroll btn custom-btn custom-border-btn mt-3 mb-4" href="./view/room.php">Đặt phòng ngay!</a>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-12 p-0" data-aos="fade-left">
                        <div class="image-slider">
                            <img src="<?php echo $BASE_PATH; ?>/layout/images/service/res6.jpg" class="slider-img" alt="Nhà hàng Cửu Long Resort">
                        </div>
                    </div>
                    <div class="col-lg-5 col-md-6 ms-auto me-auto mt-4 mt-lg-0" data-aos="fade-left">
                        ...
                        <a class="smoothscroll btn custom-btn custom-border-btn mt-3 mb-4" href="./view/service.php">Đặt ngay!</a>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container-fluid p-0">
                <div class="row align-items-center no-gutters">
                    <div class="col-lg-4 col-md-6 ms-auto me-auto mt-4 mt-lg-0" data-aos="fade-right">
                        ...
                        <a class="smoothscroll btn custom-btn custom-border-btn mt-3 mb-4" href="./view/service.php">Tìm hiểu thêm!</a>
                    </div>
                    <div class="col-lg-7 col-12 p-0" data-aos="fade-right">
                        <div class="image-slider" style="max-height: 1500px; max-width: 1000px; overflow: hidden; margin-left: auto;">
                            <img src="<?php echo $BASE_PATH; ?>/layout/images/service/pool.jpg" alt="Hồ bơi vô cực Cửu Long Resort" style="width: 100%; height: auto; display: block; object-fit: cover;">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="about-section section-padding" style="position: relative; padding: 0; background-color:#5D7B6F; text-align: justify;">
            <div class="container-fluid p-0">
                <div class="row align-items-center no-gutters">
                    <div class="col-lg-6 col-12 p-0" data-aos="fade-left">
                        <div class="image-slider">
                            <img src="<?php echo $BASE_PATH; ?>/layout/images/service/bar.jpg" class="slider-img" alt="Quầy bar Cửu Long Resort">
                        </div>
                    </div>
                    <div class="col-lg-5 col-md-6 ms-auto me-auto mt-4 mt-lg-0" data-aos="fade-left">
                        <em class="small-text">Khám phá ngay!</em>
            ...
            <div class="container-fluid p-0">
                <div class="row align-items-center no-gutters">
                    <div class="col-lg-4 col-md-6 ms-auto me-auto mt-4 mt-lg-0" data-aos="fade-right">
                        ...
                        <p class="text-white">Hành Trình Lục Tỉnh – 4N3Đ: Cảm nhận sự đa dạng trong văn hóa, tôn giáo, kiến trúc và ẩm thực vùng sông nước.</p>
                        <p class="text-white">Thoát Ly Phố Thị – 3N2Đ: Về với thiên nhiên xanh mướt của rừng tràm, sông nước miệt vườn.</p>
                        <p class="text-white">Miền Tây Một Ngày: Hành trình đưa bạn đến Tiền Giang – Bến Tre, nơi có đờn ca tài tử, đặc sản miệt vườn và lòng hiếu khách mộc mạc.</p>
                        <a class="smoothscroll btn custom-btn custom-border-btn mt-3 mb-4" href="./view/tour.php">Chi tiết tour!</a>
                    </div>
                    <div class="col-lg-7 col-12 p-0" data-aos="fade-right">
                        <div class="image-slider" style="max-height: 1000px; max-width: 1000px; overflow: hidden; margin-left: auto;">
                            <img src="<?php echo $BASE_PATH; ?>/layout/images/service/tour7.jpg" alt="Tour du lịch miền Tây Cửu Long Resort" style="width: 100%; height: auto; display: block; object-fit: cover;">
                        </div>
                    </div>
                </div>
            </div>
